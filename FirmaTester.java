...
public class FirmaTester {
    ...
    public static void main(String[] args) {
        ...
        Angestellte ang1 = new Angestellte("Taylor", "Elisabeth", "Amrummer Strasse", "10", "Hamburg", "83351", true,
                410000f);
        kmu.addAngestellte(ang1);
        // result should be 410000
        System.out.println(kmu.alleGehaelter());
        Angestellte ang2 = new Angestellte("Mueller", "Mark", "Amrummer Strasse", "11", "Berlin", "13350", false,
                10000f);
        ...
        Kunde k2 = new Kunde("Jolie", "Angelina", "Amrummer Strasse", "13", "Nizza", "03352", true);
        kmu.addKunde(k2);
        // result should be 1
        ...
        System.out.println("alle Personen 1 " + Arrays.toString(kmu.getAllePersonen()));
        ...
        System.out.println("alle Personen 2 " + Arrays.toString(kmu.getAllePersonen()));

        kmu.sortNachOrt(); 

        System.out.println("alle Personen 3" + Arrays.toString(kmu.getAllePersonen()));
